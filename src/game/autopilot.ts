...
export class AutopilotController {
  ...
  update(playerX: number, facing: 1 | -1, lanterns: AutopilotLantern[]): InputState {
    ...
    const distance = target.x - playerX;
